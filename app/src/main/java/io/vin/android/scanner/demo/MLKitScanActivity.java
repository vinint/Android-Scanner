 ...
 */
public class MLKitScanActivity extends Activity implements View.OnClickListener,ScannerView2.SingleScanCallBack,ScannerView2.MultipleScanCallBack{
    ...
    private void initScanner(){
        mScannerView.setDecoderEngine(new MLKitDecodeEngine(this,mScannerView));
